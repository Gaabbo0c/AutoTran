 ...
 * Class for poliza
 */
class polizadet extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'polizadet';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'contab_polizasdet';
	 ...
	 */
	public $picto = 'polizadet@autotran';
	...
	public $fields=array( 
		...
		'fk_poliza' =>array('type'=>'integer', 'label'=>'Fk poliza', 'enabled'=>1, 'visible'=>-2, 'notnull'=>1, 'position'=>15), 
		'asiento' =>array('type'=>'integer', 'label'=>'Asiento', 'enabled'=>1, 'visible'=>-2, 'notnull'=>1, 'position'=>20), 
		'cuenta' =>array('type'=>'varchar(50)', 'label'=>'Cuenta', 'enabled'=>1, 'visible'=>-2, 'notnull'=>1, 'position'=>25), 
		'debe' =>array('type'=>'double', 'label'=>'Debe', 'enabled'=>1, 'visible'=>-2, 'notnull'=>1, 'position'=>30), 
		'haber' =>array('type'=>'double', 'label'=>'Haber', 'enabled'=>1, 'visible'=>-2, 'notnull'=>1, 'position'=>35), 
		'descripcion' =>array('type'=>'varchar(80)', 'label'=>'Descripcion', 'enabled'=>1, 'visible'=>-2, 'position'=>40), 
		'uuid' =>array('type'=>'varchar(80)', 'label'=>'Uuid', 'enabled'=>1, 'visible'=>-2, 'position'=>45), 
		); 
	public $rowid;
	public $fk_poliza;
	public $asiento;
	...
	public function crearAsiento()
	{
		...
		$qry.= "VALUES($this->fk_poliza, ";
		$qry.= "$this->asiento, ";
		$qry.= "'$this->cuenta', ";
		$qry.= "$this->debe, ";
		$qry.= "$this->haber, ";
		$qry.= "'$this->descripcion')";
		$this->db->query($qry);
	}
	/**
